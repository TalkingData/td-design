<template>
  <div>
    <main v-if="!isDoc" class="assembly">
      ...
      >
        <editor-markdown :data="document" :editor="editor" @dom-loaded="anchorLink = $event"></editor-markdown>
      </container>
      <!-- 用法 -->
      <container
    ...
    <container v-else :anchorLink="anchorLink" :loffset="20" class=".tdDessign-example-header">
      <editor-markdown
        :data="dataList"
        @dom-loaded="anchorLink = $event"
